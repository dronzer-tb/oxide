...
public final class OxidePlugin extends JavaPlugin {
     ...
     * {@code plugins/}.
     *
     * <p>{@link NoClassDefFoundError} rather than a class-presence test: on stock Paper or Folia
     * the API is simply not on the classpath, and that is the answer.
     */
    ...
    public @Nullable ChunkGenerator getDefaultWorldGenerator(@NotNull String worldName, @Nullable String id) {
        if (vertexOwnsGeneration()) {
            getLogger().info("world '" + worldName + "': terrain is already generated by the Oxide"
                    + " Vertex Engine module, one stage lower than a Bukkit generator can reach."
                    + " Not registering a ChunkGenerator for this world.");
            return null;
        }
        Long seed = null;
